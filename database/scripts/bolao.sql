...
-- Table `bolao`.`arquivo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bolao`.`arquivo` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `uuid` BINARY(16) NOT NULL,
...
-- -----------------------------------------------------
-- Table `bolao`.`messenger_messages`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bolao`.`messenger_messages` (
...
-- -----------------------------------------------------
-- Table `bolao`.`apostador`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bolao`.`apostador` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `uuid` BINARY(16) NOT NULL,
  `usuario_id` INT NOT NULL,
  `nome` VARCHAR(60) NOT NULL,
...
-- -----------------------------------------------------
-- Table `bolao`.`rememberme_token`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bolao`.`rememberme_token` (
...
-- -----------------------------------------------------
-- Table `bolao`.`reset_password_request`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bolao`.`reset_password_request` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `bolao`.`loteria_raterio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bolao`.`loteria_raterio` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `uuid` BINARY(16) NOT NULL,
